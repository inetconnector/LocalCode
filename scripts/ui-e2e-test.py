...
def handler(route):
    ...
    if path=='engines/status':
        ...
        values={
          ...
          'native':{'engine':'native','display_name':'LocalCode nativ','enabled':True,'installed':True,'authenticated':True,'executable':'embedded','version':'6.4.0'}
        }
