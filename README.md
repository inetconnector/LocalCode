...
Bild-, Zeichen-, Diagramm- und Asset-Aufgaben müssen eine konkrete Artefaktdatei ändern, etwa SVG, HTML/Canvas, CSS oder eine Bilddatei. Eine Beschreibung oder ein SVG-Beispiel nur in einer README zählt nicht als fertiges Bild. Explizit genannte Bildpfade wie `assets/castle.svg` oder `preview.webp` werden als verpflichtende Projektdateien erkannt.
