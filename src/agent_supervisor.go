...
func actionAllowedForIntent(intent taskIntent, action AgentAction) (bool, string) {
	...
	if intent.Kind == "analyze" {
		...
		case "project_info", "tool_inventory", "discover_tool", "list_files", "read_file", "search_text", "engine_repo_map", "aider_repo_map", "web_search", "web_fetch", "mcp_list_tools", "mcp_list_resources", "mcp_read_resource", "mcp_list_prompts", "mcp_get_prompt", "memory_list", "finish", "ask_user":
			return true, ""
		case "git":
